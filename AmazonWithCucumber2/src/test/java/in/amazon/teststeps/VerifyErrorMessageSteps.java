...
public class VerifyErrorMessageSteps extends Driver {
	...
	public void he_hovers_the_pointer_over_the_hello_sign_in_menu() {
	...
	@When("he enters an invalid email address in the Email text-box")
	public void he_enters_an_invalid_email_address_in_the_email_text_box() {

		signIn.enterEmail("chinchan1234@gmail.com");
	}
